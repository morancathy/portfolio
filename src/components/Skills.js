  ...
  return (
    <section className="Skills-section">
      ...
      <div className="skills-p">
        <p id="skills-p">Striving to continuously learn, below are a few technologies I have experience with...</p>
      </div>
      <div className="skills-imgs">
        ...
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/svelte/svelte-original-wordmark.svg" alt="svelte"/>
        ...
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original-wordmark.svg" alt="postgresgl"/>
        ...
        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/gulp/gulp-plain.svg" alt="gulp"/>
